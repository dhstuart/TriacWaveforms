...
% vrms_mins = [27.1%GE Energy Smart Par20	DIR-01-01
% 27.5%Philips PAR30 AirFlux	DIR-02-01
% 26.7%LiteTronics 10W PAR30LN	DIR-03-01
% 25.5%LSGC Definity Par30 Short	DIR-04-01
% 22.3%GE Energy Smart Par38	DIR-05-01
% 25.3%Toshiba ECORE PAR38 1100	DIR-06-01
% 26.4%LSGC Definity Par38 HO	DIR-07-01
% 16.1%LEDnovation Enhancelite PAR38	DIR-08-01
% 18.9%TCP	DIR-09-01
% 26.9%Feit 75EW PAR38	DIR-10-01
% 16.4%enLux R20F Series	DIR-11-01
% 53.4%Msi xPAR-38	DIR-12-01
% 57.1%Acculamp S-Series Par 20 LED	DIR-13-01
% 23.6%Philips PAR38 Indoor Flood LED	DIR-14-01
% 26.6%Osram Sylvania Ultra PAR30	DIR-15-01
% 65.6%Cree PAR38 LED	DIR-16-01
% ]; %(directional-lamp testing  Round up +1
% vrms_mins = ceil(vrms_mins)+1;  %Round up +1
...
for i = 1:length(vrms_mins_ratio)
    ...
    vrms_eqn = @(t)((1/2*(pi-sin(2*pi)/2)-1/2*(t-sin(2*t)/2))/(pi-0)).^(1/2)/2.^(1/2)-vrms_mins_ratio(i);
